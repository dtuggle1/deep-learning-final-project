...
class CustomClassifier(nn.Module):
    def __init__(self):
        ...
        self.conv1d = nn.Conv1d(in_channels=128, out_channels=128, kernel_size=3, padding=1)
        self.relu = nn.ReLU()
        self.linear = nn.Linear(128 , 2)  # Change the output dimension to (128, 64)
...
if __name__ == '__main__':
    ...
    ######################################################
    # add convolution layer in classifier before linear
